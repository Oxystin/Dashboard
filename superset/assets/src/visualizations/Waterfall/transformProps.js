export default function transformProps(chartProps) {
    ...
    const { numberFormat,waterfallColorTotal ,waterfallColorPositive ,waterfallColorNegative, dateTimeFormat, waterfallLabelRotate, waterfallTimeShift, waterfallHideControl} = formData;
